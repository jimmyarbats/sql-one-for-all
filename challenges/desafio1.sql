...
CREATE TABLE history(
    ...
    reproduction_date_history DATETIME NOT NULL,
...
INSERT INTO users (name_user, age_user, id_plan, signature_date_user)
VALUES
...
INSERT INTO albums (name_album, id_artist, release_year_album)
VALUES
  ('Renaissance', 1, 2022),
  ('Jazz', 2, 1978),
  ('Hot Space', 2, 1982),
...
INSERT INTO musics (name_music, id_album, duration_music)
VALUES
  ('BREAK MY SOUL', 1, 279),
  ('VIRGOS GROOVE', 1, 369),
...
INSERT INTO following_artists (id_user, id_artist)
VALUES
  (1, 1),
  (1, 2),
  (1, 3),
...
INSERT INTO history (id_user, id_music, reproduction_date_history)
VALUES 
